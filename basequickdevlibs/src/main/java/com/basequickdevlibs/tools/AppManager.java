...
import com.basequickdevlibs.base.baseactivity.BaseQuickActivty;
...
public class AppManager {
	 ...
	 */
	public BaseQuickActivty currentActivity() {
		BaseQuickActivty activity = (BaseQuickActivty) mActivityStack.lastElement();
		return activity;
	}
