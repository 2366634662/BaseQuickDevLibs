...
public abstract class BaseMVPRefAndLoadActivity<V, T extends BasePresenter<V>> extends BaseQuickActivty implements IUpdateDataView, IBaseStatusView {
	/**
