package com.basequickdevlibs.view;
...
//        implements View.OnClickListener
{
    ...
    private LinearLayout error_retry_view;
    private LinearLayout no_network_retry_view;
    private LinearLayout empty_retry_view;
//    private MutipOnClick mutipOnClick;
//
//    public void setMutipOnClick(MutipOnClick mutipOnClick) {
//        this.mutipOnClick = mutipOnClick;
//    }
...
//        loading_view = (ImageView) mLoadingView.findViewById(R.id.loading_view);
//        animationDrawable = (AnimationDrawable) loading_view.getBackground();

//        error_retry_view = (LinearLayout) mErrorView.findViewById(R.id.error_retry_view);
//        no_network_retry_view = (LinearLayout) mNoNetworkView.findViewById(R.id.no_network_retry_view);
//        empty_retry_view = (LinearLayout) mEmptyView.findViewById(R.id.empty_retry_view);

//        error_retry_view.setOnClickListener(this);
//        no_network_retry_view.setOnClickListener(this);
//        empty_retry_view.setOnClickListener(this);
...
//        if (mutipOnClick == null) {
//            return;
//        }
//        if (v.getId() == R.id.error_retry_view) {
//            mutipOnClick.mutipOnClickListener();
//        } else if (v.getId() == R.id.no_network_retry_view) {
//            mutipOnClick.mutipOnClickListener();
//        } else if (v.getId() == R.id.empty_retry_view) {
//            mutipOnClick.mutipOnClickListener();
//        }
//    }

//    public interface MutipOnClick {
//        void mutipOnClickListener();
//    }
}